...
const Header: React.FC<HeaderProps> = ({ sum, balance, menu }) => {
	...
	const isAlpha = process.env.REACT_APP_ROLLBAR_ENV === 'alpha';
				...
				<div className="header-container is-desktop">
					...
					<div className="navbar-manu">
						...
						<a
							...
							className="navbar-item"
						>
							<span className="navbar-text">Liquidity</span>
						</a>
						<a href="/#farm" className="navbar-item">
							<span className={`navbar-text ${menu === 'farm' ? 'active' : ''}`}>Farms</span>
						</a>
						<a href="/" className="navbar-item">
							<span className={`navbar-text ${menu === 'info' ? 'active' : ''}`}>Info</span>
						</a>
						<a
							...
							className="navbar-item"
						>
							<span className={`navbar-text ${menu === 'NFT' ? 'active' : ''}`}>NFT</span>
						</a>
					</div>
