    ...
    var y = function(i) {
        ...
        return _(l, [{
            ...
            value: function(e) {
                ...
                var t, i = 2047 & l.__kBitConversionInts[1] >>> 20,
                    _ = i - 1023,
                    n = (_ >>> 5) + 1,
                    g = new l(n, 0 > e),
            ...
            value: function(e) {
                ...
                if (0 == (t & t - 1)) {
                    ...
                    do {
                        for (var y, k = 0, D = 0;;) {
                            if (y = void 0, g - 48 >>> 0 < h) y = g - 48;
                            else if ((32 | g) - 97 >>> 0 < b) y = (32 | g) - 87;
                            else {
                                f = !0;
                                break
                            }
            ...
            value: function(e, t) {
                ...
                for (var r = Array(u), d = u - 1, h = 0, b = 0, m = 0; m < _ - 1; m++) {
                    ...
                    var f = g - b;
                    for (h = c >>> f, b = 32 - f; b >= g;) r[d--] = l.__kConversionChars[h & o], h >>>= g, b -= g
                }
                var y = (h | a << b) & o;
                for (r[d--] = l.__kConversionChars[y], h = a >>> g - b; 0 !== h;) r[d--] = l.__kConversionChars[h & o], h >>>= g;
            ...
            value: function(e, t, _) {
                ...
                r.__trim();
                for (var D = l.__toStringGeneric(r, t, !0); d.length < h;) d = "0" + d;
            ...
            value: function(e, t) {
                ...
                for (var u = _; u < t; u++) g.__setDigit(u, 0);
                return g
            }
        }, {
            key: "__absoluteAnd",
            ...
            value: function(e, t, _, g, o) {
                ...
                if (o.length > g)
                    for (o.__setDigit(g++, a + s); g < o.length;) o.__setDigit(g++, 0);
            ...
            value: function(e, t) {
                ...
                var b = new l(s, n);
                if (0 === a)
                    for (var m = o; m < _; m++) b.__setDigit(m - o, e.__digit(m));
                else {
                    for (var c, v = e.__digit(o) >>> a, f = _ - o - 1, y = 0; y < f; y++) c = e.__digit(y + o + 1), b.__setDigit(y, c << 32 - a | v), v = c >>> a;
                    b.__setDigit(f, v)
                }
            ...
            value: function(e, t, _) {
                ...
                var m, c = s < t.length ? t.__digit(s) : 0,
                    v = 31 & e;
                if (0 === v) {
                    var f = 0 - (65535 & c) - u;
                    u = 1 & f >>> 16;
