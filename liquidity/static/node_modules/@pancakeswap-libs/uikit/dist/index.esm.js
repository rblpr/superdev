...
var Icon$6 = function(props) {
    return (React.createElement(Svg, __assign({
        ...
        React.createElement("path", {
            d: "M10.2299 1.95C10.2299 1.29 9.68992 0.75 9.02992 0.75C8.36992 0.75 7.82991 1.26 7.82991 1.92C7.82991 5.67 9.29992 9.27 11.9099 11.91L13.6799 10.32C11.4899 8.13 10.2299 5.1 10.2299 1.95Z"
        }),
        React.createElement("path", {
            d: "M18.0599 14.28L16.2899 15.87C18.4799 18.06 19.7399 21.09 19.7399 24.21L19.7399 25.2L18.5099 23.97C18.0299 23.49 17.2799 23.49 16.8299 23.97C16.3499 24.42 16.3499 25.2 16.8299 25.65L20.0999 28.89C20.3099 29.1 20.6399 29.25 20.9399 29.25C21.2699 29.25 21.5699 29.13 21.7799 28.89L25.0499 25.62C25.2899 25.38 25.4099 25.08 25.4099 24.78C25.4099 24.48 25.2899 24.18 25.0499 23.94C24.5699 23.46 23.8199 23.46 23.3699 23.94L22.1399 25.17L22.1399 24.18C22.1099 20.46 20.6399 16.89 18.0599 14.28Z"
        }),
        React.createElement("path", {
            d: "M9.89993 28.89L13.1699 25.65C13.4099 25.41 13.5299 25.11 13.5299 24.81C13.5299 24.51 13.4099 24.21 13.1699 23.97C12.7199 23.52 11.9399 23.52 11.4899 23.97L10.2599 25.2L10.2599 24.21C10.2599 20.85 11.6999 17.64 14.2199 15.42L17.3999 12.54C20.4299 9.84 22.1699 6 22.1699 1.95C22.1699 1.29 21.6299 0.75 20.9699 0.75C20.3099 0.75 19.7699 1.26 19.7699 1.92C19.7699 5.31 18.3299 8.52 15.8099 10.74L12.5999 13.59C9.56993 16.29 7.85993 20.13 7.85993 24.18L7.85993 25.2L6.62993 23.97C6.17993 23.52 5.39993 23.52 4.94993 23.97C4.49993 24.42 4.49993 25.2 4.94993 25.65L8.21993 28.92C8.69993 29.37 9.44993 29.37 9.89993 28.89Z"
        })
    ));
};
...
var Icon$q = function(props) {
    return (React.createElement(Svg, __assign({
        ...
        React.createElement("path", {
            d: "M44.344 26.7212C43.0874 31.6032 38.6862 35.6961 32.6846 37.8816V19.1923C32.6846 8.75864 38.1213 0.301025 45.0759 0.301025L44.6708 24.1939C44.6612 25.0462 44.5515 25.8944 44.344 26.7212Z",
            fill: "#202251"
        }),
        React.createElement("path", {
            d: "M0.799337 26.7212C2.05699 31.6032 6.45822 35.6961 12.4598 37.8816V19.1923C12.4598 8.75864 7.02305 0.301025 0.0673828 0.301025L0.473555 24.1939C0.482817 25.0462 0.592161 25.8944 0.799337 26.7212Z",
            fill: "#202251"
        }),
        React.createElement("path", {
            d: "M22.6894 14.2087C22.6894 14.2087 29.3721 22.6642 29.3721 30.8458C29.3721 38.0837 22.6894 40.5781 22.6894 40.5781H22.6809C22.6809 40.5781 15.9971 38.0837 15.9971 30.8458C15.9971 22.6642 22.6798 14.2087 22.6798 14.2087",
            fill: "#202251"
        })));
};
...
var ButtonMenuItem = function(_a) {
    var _b = _a.isActive,
        ...
        _c = _a.variant,
        variant = _c === void 0 ? variants.PRIMARY : _c,
        as = _a.as,
...
var getHeight = function(_a) {
    var _b = _a.scale,
        scale = _b === void 0 ? scales$2.MD : _b;
    switch (scale) {
        case scales$2.SM:
            return "32px";
            fill: textColor
        }),
        React.createElement("path", {
            d: "M185.869 18.7051C185.493 18.6471 185.113 18.6181 184.733 18.6183C184.34 18.6191 183.947 18.6481 183.559 18.7051C183.497 18.7138 183.441 18.7445 183.4 18.7915C183.359 18.8386 183.336 18.8988 183.337 18.9611V33.3829L174.965 18.8299C174.945 18.796 174.918 18.7669 174.886 18.7449C174.854 18.7229 174.817 18.7086 174.778 18.703C173.919 18.5873 173.048 18.5873 172.189 18.703C172.128 18.7119 172.071 18.7427 172.031 18.7897C171.99 18.8367 171.968 18.8968 171.968 18.959V37.5626C171.968 37.6244 171.99 37.6842 172.03 37.7312C172.07 37.7782 172.126 37.8092 172.187 37.8186C172.954 37.9342 173.733 37.9342 174.5 37.8186C174.561 37.8092 174.617 37.7782 174.657 37.7312C174.697 37.6842 174.719 37.6244 174.719 37.5626V23.4157L182.952 37.6969C182.971 37.7312 182.999 37.7605 183.031 37.7825C183.064 37.8045 183.102 37.8187 183.141 37.8239C183.597 37.8839 184.056 37.9129 184.516 37.9106C184.968 37.9132 185.42 37.8843 185.869 37.8239C185.93 37.8152 185.987 37.7845 186.028 37.7374C186.069 37.6904 186.091 37.6301 186.091 37.5679V18.959C186.091 18.897 186.068 18.8373 186.027 18.7907C185.986 18.7441 185.93 18.7137 185.869 18.7051Z",
            fill: textColor
        }),
        React.createElement("path", {
            d: "M55.3442 34.7212C54.0876 39.6032 49.6864 43.6961 43.6848 45.8816V27.1923C43.6848 16.7586 49.1216 8.30103 56.0762 8.30103L55.6711 32.1939C55.6615 33.0462 55.5518 33.8944 55.3442 34.7212Z",
            fill: textColor
        }),
        React.createElement("path", {
            d: "M11.7993 34.7212C13.057 39.6032 17.4582 43.6961 23.4598 45.8816V27.1923C23.4598 16.7586 18.0231 8.30103 11.0674 8.30103L11.4736 32.1939C11.4828 33.0462 11.5922 33.8944 11.7993 34.7212Z",
            fill: textColor
        }),
        React.createElement("path", {
            d: "M33.6891 22.2087C33.6891 22.2087 40.3719 30.6642 40.3719 38.8458C40.3719 46.0837 33.6891 48.5781 33.6891 48.5781H33.6807C33.6807 48.5781 26.9968 46.0837 26.9968 38.8458C26.9968 30.6642 33.6796 22.2087 33.6796 22.2087",
            fill: textColor
        }),
    ));
};

var LogoWithText = React.memo(Logo, function(prev, next) {
...
var Logo$1 = function(_a) {
    ...
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, {
            ...
            onClick: togglePush,
            mr: "24px"
        }, isPushed ? (React.createElement(Icon$N, {
            width: "24px",
            color: "textSubtle"
        })) : (React.createElement(Icon$M, {
            width: "24px",
            color: "textSubtle"
        }))),
...
var Logo$2 = React.memo(Logo$1, function(prev, next) {
    ...
    return (React.createElement(Modal, {
        ...
        React.createElement(Flex, {
            ...
            React.createElement("img", {
                src: "/images/farms/wallet_profile.png",
                alt: "profile avatar",
                height: "40px",
                width: "40px"
            }),
            React.createElement(Flex, {
                ...
                }, account.substring(0, 11) + "..." + account.substring(account.length - 9)),
                React.createElement("img", {
