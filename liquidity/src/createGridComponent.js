...
export type Props < T > = { |
    ...
    innerRef ? : any,
    innerElementType ? : string | React$AbstractComponent < InnerProps,
    any > ,
    ...
    outerRef ? : any,
    outerElementType ? : string | React$AbstractComponent < OuterProps,
    any > ,
...
export default function createGridComponent({
    ...
    return class Grid < T > extends PureComponent < Props < T > , State > {
        ...
        scrollToItem({
            ...
            this.scrollTo({
                scrollLeft: columnIndex !== undefined ?
                    getOffsetForColumnAndAlignment(
                        this.props,
                        columnIndex,
                        align,
        ...
        render() {
            ...
            if (columnCount > 0 && rowCount) {
                for (
                    let rowIndex = rowStartIndex; rowIndex <= rowStopIndex; rowIndex++
                ) {
                    for (
                        let columnIndex = columnStartIndex; columnIndex <= columnStopIndex; columnIndex++
                    ) {
                        items.push(
